...
const Points = () => {
  ...
  useEffect(() => {
    async function loadPosition() {
      ...
      if (status !== 'granted') {
        Alert.alert('Inconsistencia detectada', 'Para melhor uso da aplicação permita o acesso a sua localização');
        return;
      }
  ...
  function handleSelectItem(id: number) {
    ...
    if (alreadySelected >= 0) {
      const fiteredItems = selectedItems.filter(item => item !== id);
